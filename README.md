# zettelschrift
An agnostic, semantic extension for lightweight markup languages  Adds typed wikilinks (optionally convertible to notes themselves) and Folgezettel logic without breaking compatibility with your existing ecosystem. Provides agnostic tools for visualisation and conversion.
